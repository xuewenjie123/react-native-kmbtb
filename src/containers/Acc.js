...
import { FlatList, TouchableOpacity, Text, View, TextInput ,ToastAndroid} from 'react-native';
...
export default class FlatListBasic extends PureComponent {
    ...
    // 跳转到指定位置
    _doActionToItem = () => {
        // viewPosition: 指定选定行显示的位置，0代表top，1代表middle，1代表bottom
    ...
    render() {
        return(
            <FlatList
                ...
                // 决定当距离内容最底部还有多远时触发onEndReached回调；数值范围0~1，例如：1表示可见布局的最底端距离content最底端等于可见布局一半高度的时候调用该回调
